...
export default function Trending() {
    ...
    return(
        <section className='container-fluid bg-dark'>
            ...
            <div className="row">
                <div className="col-4 d-flex justify-content-center align-items-center" ><h1 className='text-info text-center fw-light'>Trending<br/> Movies <br/>To Watch Now</h1></div>
            {
                ...
                return(
                    <div className='p-2 col-md-2 align-items-end'>
                        <Link to = {"/Trending/"+item.id}>
                            ...
                            more details</Link>
                            <h5 className='text-info text-center mt-1 fw-light'>{item.title}</h5>
                    </div>
                )
            })
