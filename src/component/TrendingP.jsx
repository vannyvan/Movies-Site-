...
export default function TrendingP() {
  ...
  return(
      <section className='container-fluid bg-dark'>
          ...
          <div className="row">
              <div className="col-4 d-flex justify-content-center align-items-center" ><h1 className='text-info text-center fw-light'>Trending<br/>People<br/>In The World Now</h1></div>
          {
          movies && movies.map( (item) => {
              return(
                  <div className='p-2 col-md-2 align-items-end me-3'>
                     <Link to={"/TrendingP/"+item.id}>
